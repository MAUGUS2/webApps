...
```
📚 aplicacoes-web-moveis/
├── 📄 indice-geral.html          # Página inicial do curso
├── 📄 README.md                   # Documentação
├── 📄 LICENSE                     # Licença MIT
├── 📄 CONTRIBUTING.md             # Guia de contribuição
├── 📄 .gitignore                  # Arquivos ignorados
├── 🗂️ shared/                     # Recursos compartilhados
│   ├── css/                       # Estilos globais
│   ├── js/                        # Scripts globais
│   └── images/                    # Imagens compartilhadas
├── 🗂️ 16_01-HTML/                 # Aula 1: HTML
│   ├── index.html
│   ├── 01-conceitos.html
│   ├── 02-ambiente.html
│   └── ...
├── 🗂️ 16_02-CSS/                  # Aula 2: CSS
│   ├── index.html
│   ├── 01-basico.html
│   └── ...
├── 🗂️ 16_03-CSS-Parte-2/          # Aula 3: CSS Avançado
├── 🗂️ 16_04-HTML_Semantico_e_CSS/ # Aula 4: HTML Semântico
├── 🗂️ 16_05-JAVASCRIPT_1/         # Aula 5: JavaScript Parte 1
└── 🗂️ 16_06-JAVASCRIPT_2/         # Aula 6: JavaScript Parte 2
```
...
Contribuições são muito bem-vindas! Veja o arquivo [CONTRIBUTING.md](CONTRIBUTING.md) para detalhes sobre como contribuir com o projeto.
